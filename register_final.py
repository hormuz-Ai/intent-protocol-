...
# The key with trailing whitespace stripped
AGENT_PK = "0xf4D056604727ff966077a425be1c733fffdba22d8a30ea8ea38b569d16b553942".strip()

w3 = Web3(Web3.HTTPProvider(RPC))
acct = w3.eth.account.from_key(AGENT_PK)
...
if bal < 50000:
    print("❌ Not enough ETH for gas. Mine a tiny amount to this address first.")
    exit(1)
